...
More specifically, I do not see an existing viable solution that successfully
...
* Visible latency of desktop environments is a constant source of distraction.
  ...
  cards! This means keystrokes and mouse clicks often get misdelivered or lost,
